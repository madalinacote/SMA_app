...
// the chart I used for the statistics screen
class _MyChartState extends State<MyChart>{
  ...
  BarChartGroupData makeGroupData(int x, double y){
    return BarChartGroupData(
        x: x,
        barRods: [
          BarChartRodData(    // the bars for each date
              toY: y,
  ...
  Widget leftTiles(double value, TitleMeta meta) {  // progress indicators in k of money
    const style = TextStyle(
        color: Colors.grey,
        fontWeight: FontWeight.bold,
        fontSize: 14
